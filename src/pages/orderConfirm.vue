     ...
     <div class="edit-wrap">
       ...
       <div class="item">
         ...
         <select name="city" v-model="checkItem.receiverCity">
           <option value="北京">北京</option>
           <option value="上海">上海</option>
           <option value="天津">重庆</option>
         </select>
         <select name="district" v-model="checkItem.receiverDistrict">
           <option value="北京">东城区</option>
           <option value="上海">西城区</option>
           <option value="天津">冬瓜区</option>
           <option value="天津">西丁区</option>
           <option value="天津">白菜区</option>
           <option value="天津">极度深寒区</option>
           <option value="天津">不低区</option>
         </select>
       </div>
       <div class="item">
...
export default{
  ...
  data(){
    return {
      ...
      count: 0, //商品总件数
      checkItem: {}, //保存需要操作的地址对象
      userAction: '', //用户的行为 0：新增  1：编辑  2：删除
      showDelModal: false, //是否显示删除确认弹框
